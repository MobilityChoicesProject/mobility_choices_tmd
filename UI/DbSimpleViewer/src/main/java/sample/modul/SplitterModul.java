...
import at.fhv.transportClassifier.segmentsplitting.SpeedThresholdSplitter;
 ...
 */
public class SplitterModul implements Modul {
  ...
  private void smoothList(){
    ...
    SpeedThresholdSplitter speedThresholdSplitter = new SpeedThresholdSplitter();
    List<LocalDateTime> split = speedThresholdSplitter.split(tracking);

    for (LocalDateTime keyTime : split) {
