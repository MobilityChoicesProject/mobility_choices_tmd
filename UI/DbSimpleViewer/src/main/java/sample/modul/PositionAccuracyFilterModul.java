...
import at.fhv.filters.PositionAccuracyFilter;
 ...
 */
public class PositionAccuracyFilterModul implements Modul {
  ...
  private void filterList(){
    ...
    PositionAccuracyFilter filter = new PositionAccuracyFilter();
    ...
    routeSelectorAndSaver.setTracking(filteredList,"accuracyFilter");
    gpsListViewUi.hide();
