 ...
 */
public class SamePositionWorseAccuracyFilterModul implements Modul {
  ...
  private void filterList(){
    ...
    SamePositionWorseAccuracyFilter filter = new SamePositionWorseAccuracyFilter();
    ...
    routeSelectorAndSaver.setTracking(filteredList,"positionAccuracy");
    gpsListViewUi.hide();
  ...
  public String getName() {
    return "Same Position, Worse Accuracy Filter";
  }
