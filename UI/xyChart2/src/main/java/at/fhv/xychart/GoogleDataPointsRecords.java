 ...
 */
public abstract class GoogleDataPointsRecords implements DataPointRecords {
...
//
//  public GoogleDataPointsRecords(){
//        try{
//
//            FileInputStream fileInputStream = new FileInputStream("D:\\Studium\\Master\\Masterarbeit\\fhgpsLoggerTracks\\1484661707609.gpsTrack");
//
//            TrackingDataProtos.TrackingPr trackingPr = TrackingDataProtos.TrackingPr.parseFrom(fileInputStream);
//            long timestamp1 = trackingPr.getGpsTrackingPointsList().get(0).getTimestamp();
//
//            accelerometerTrackingPointsList = trackingPr.getAccelerometerTrackingPointsList();
//            long timestamp = accelerometerTrackingPointsList.get(0).getTimestamp();
//            long timeOffsetInMillis=0;
//            long lastTimeSTamp=0;
//            for (TrackingDataProtos.TrackingPr.AccelerometerTrackingPointPr trackingPointPr : accelerometerTrackingPointsList) {
...
//
//            Date date = new Date(trackingPr.getStartTime());
//            System.out.print(date);
//            long test =timestamp-timeOffsetInMillis;
